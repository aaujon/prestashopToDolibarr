...
class DolibarrInvoiceLine {
	...
	public $payment_mode_id = ""; // not used but needed, see in DolibarrInvoice
	public $product_id = "";
	public $product_ref = "";
...
class DolibarrInvoice {
    ...
    public $total_vat;
    public $total;
    public $payment_mode_id = ""; // 1 = TIP, 2 = VIR, 3 = PRELEVEMENT, 4 = DIRECT, 6 = CB, 7 = CHEQUE, 50 = ONLINE
    public $note_private = "Synchronised from Prestashop";
    public $note_public = "";
    public $status = 0; // 0 = draft, 1 = validated, 2 = paid, 3 = cancelled
